...
extern NSString * const kSALinkAttributesName;
extern NSString * const kSAActiveLinkAttributesName;
extern NSString * const kCJIsLinkAttributesName;
//点击链点唯一标识
extern NSString * const kSALinkIdentifierAttributesName;
extern NSString * const kSALinkLengthAttributesName;
extern NSString * const kSALinkRangeAttributesName;
extern NSString * const kSALinkParameterAttributesName;
extern NSString * const kCJClickLinkBlockAttributesName;
extern NSString * const kCJLongPressBlockAttributesName;
extern NSString * const kSALinkNeedRedrawnAttributesName;
/**
 不允许换行字符
 */
