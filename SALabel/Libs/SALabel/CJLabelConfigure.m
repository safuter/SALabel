...
NSString * const kSALinkAttributesName                       = @"kSALinkAttributesName";
NSString * const kSAActiveLinkAttributesName                 = @"kSAActiveLinkAttributesName";
NSString * const kCJIsLinkAttributesName                     = @"kCJIsLinkAttributesName";
NSString * const kSALinkIdentifierAttributesName             = @"kSALinkIdentifierAttributesName";
NSString * const kSALinkLengthAttributesName                 = @"kSALinkLengthAttributesName";
NSString * const kSALinkRangeAttributesName                  = @"kSALinkRangeAttributesName";
NSString * const kSALinkParameterAttributesName              = @"kSALinkParameterAttributesName";
...
NSString * const kSALinkNeedRedrawnAttributesName            = @"kSALinkNeedRedrawnAttributesName";
                                                      ...
                                                      islink:(BOOL)isLink
{
    ...
    if (!CJLabelIsNull(linkAttributes) && linkAttributes.count > 0) {
        [imageAttributedString addAttribute:kSALinkAttributesName value:linkAttributes range:imgRange];
    }
    if (!CJLabelIsNull(activeLinkAttributes) && activeLinkAttributes.count > 0) {
        [imageAttributedString addAttribute:kSAActiveLinkAttributesName value:activeLinkAttributes range:imgRange];
    }
    if (!CJLabelIsNull(parameter)) {
        [imageAttributedString addAttribute:kSALinkParameterAttributesName value:parameter range:imgRange];
    }
    ...
    if (isLink) {
        ...
        [imageAttributedString addAttribute:kSALinkIdentifierAttributesName value:@(arc4random()) range:imgRange];
        [imageAttributedString addAttribute:kSALinkLengthAttributesName value:@(imgRange.length) range:imgRange];
    }else{
        [imageAttributedString addAttribute:kCJIsLinkAttributesName value:@(NO) range:imgRange];
        [imageAttributedString addAttribute:kSALinkLengthAttributesName value:@(0) range:imgRange];
    }
                                                      ...
                                                      islink:(BOOL)isLink
{
    ...
    if (!CJLabelIsNull(linkAttributes) && linkAttributes.count > 0) {
        ...
        [attributedString addAttribute:kSALinkAttributesName value:linkAttributes range:range];
    }
    if (!CJLabelIsNull(activeLinkAttributes) && activeLinkAttributes.count > 0) {
        activeLinkFont = activeLinkAttributes[NSFontAttributeName];
        [attributedString addAttribute:kSAActiveLinkAttributesName value:activeLinkAttributes range:range];
    }
    ...
    if ((linkFont && activeLinkFont) && (![linkFont.fontName isEqualToString:activeLinkFont.fontName] || linkFont.pointSize != activeLinkFont.pointSize)) {
        [attributedString addAttribute:kSALinkNeedRedrawnAttributesName value:@(YES) range:range];
    }else{
        [attributedString addAttribute:kSALinkNeedRedrawnAttributesName value:@(NO) range:range];
    }
    if (!CJLabelIsNull(parameter)) {
        [attributedString addAttribute:kSALinkParameterAttributesName value:parameter range:range];
    }
    if (!CJLabelIsNull(clickLinkBlock)) {
    ...
    if (isLink) {
        ...
        [attributedString addAttribute:kSALinkIdentifierAttributesName value:@(arc4random()) range:range];
        [attributedString addAttribute:kSALinkLengthAttributesName value:@(range.length) range:range];
    }else{
        [attributedString addAttribute:kCJIsLinkAttributesName value:@(NO) range:range];
        [attributedString addAttribute:kSALinkLengthAttributesName value:@(0) range:range];
    }
    return attributedString;
}
                               ...
                               identifier:(NSString *)identifier
{
    ...
    [attStr addAttribute:kSALinkStringIdentifierAttributesName value:identifier range:NSMakeRange(0, attStr.length)];
...
+ (NSRange)getFirstRangeWithAttString:(NSAttributedString *)withAttString inAttString:(NSAttributedString *)attString {
    ...
    NSString *identifier = strDic[kSALinkStringIdentifierAttributesName];
    ...
    NSString *withIdentifier = withStrDic[kSALinkStringIdentifierAttributesName];
...
+ (NSArray <NSValue *>*)getLinkAttStringRangeArray:(NSAttributedString *)linkAttString inAttString:(NSAttributedString *)attString {
    ...
    if (strRanges.count > 0) {
        ...
        NSString *withKey = withStrDic[kSALinkStringIdentifierAttributesName];
        ...
        [strRanges enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            NSString *key = strDic[kSALinkStringIdentifierAttributesName];
...
@property (nonatomic, weak) SALabel *label;//选择复制对应的label
...
- (void)copy:(nullable id)sender {
    if (_startCopyRunItem && _endCopyRunItem) {
        ...
        @autoreleasepool {
            ...
            str = [str stringByReplacingOccurrencesOfString:KSALabelImageVar withString:@"[图片]"];
            str = [str stringByReplacingOccurrencesOfString:KSALabelTableVar withString:@"[表格]"];
...
#pragma mark - 显示放大镜
- (void)showMagnifyInCJLabel:(SALabel *)label
...
#pragma mark - 显示选择视图
- (void)showSelectViewInCJLabel:(SALabel *)label
