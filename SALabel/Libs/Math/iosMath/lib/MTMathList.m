...
+ (instancetype)atomWithType:(MTMathAtomType)type value:(NSString *)value
{
    switch (type) {
        ...
        case KMTMathAtomOverset:
            return [[MTOverSet alloc] init];
            
        case KMTMathAtomUnderset:
            return [[MTUnderSet alloc] init];
...
@implementation MTOverSet
- (instancetype)init {
    self = [super initWithType:KMTMathAtomOverset value:@""];
    if (self) {
...
- (id)copyWithZone:(NSZone *)zone
{
    MTOverSet* overset = [super copyWithZone:zone];
    overset.topspace = [self.topspace copyWithZone:zone];
    overset.bottomspace = [self.bottomspace copyWithZone:zone];
//    frac.leftDelimiter = [self.leftDelimiter copyWithZone:zone];
//    frac.rightDelimiter = [self.rightDelimiter copyWithZone:zone];
    return overset;
}
...
- (instancetype)finalized
{
    MTOverSet *newOverset = [super finalized];
    newOverset.topspace = newOverset.topspace.finalized;
    newOverset.bottomspace = newOverset.bottomspace.finalized;
    return newOverset;
}

@end

@implementation MTUnderSet
- (instancetype)init {
    self = [super initWithType:KMTMathAtomUnderset value:@""];
    if (self) {
...
- (id)copyWithZone:(NSZone *)zone
{
    MTUnderSet* underset = [super copyWithZone:zone];
    underset.topspace = [self.topspace copyWithZone:zone];
    underset.bottomspace = [self.bottomspace copyWithZone:zone];
//    frac.leftDelimiter = [self.leftDelimiter copyWithZone:zone];
//    frac.rightDelimiter = [self.rightDelimiter copyWithZone:zone];
    return underset;
}
...
- (instancetype)finalized
{
    MTUnderSet *newUnderset = [super finalized];
    newUnderset.topspace = newUnderset.topspace.finalized;
    newUnderset.bottomspace = newUnderset.bottomspace.finalized;
    return newUnderset;
}
